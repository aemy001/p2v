  ...
  const values = [
    {
      ...
      description:
        "In our world, 99.9% accuracy isn't a goal. it's the baseline. We are obsessed with the details from container intake to final B2B distribution.",
      icon: <CheckCircle2 className="w-6 h-6 text-blue-900" />,
    },
    {
      title: "Radical Transparency",
      description:
        "We operate as a 'Glass House.' Whether it's good news or a logistical challenge, we provide total honesty through real-time data integration.",
      icon: <Eye className="w-6 h-6 text-blue-900" />,
    },
    {
      title: "Enterprise Agility",
      description:
        "We reject the bureaucracy that slows down the industry. We provide the scale of a giant with the responsiveness of a dedicated partner.",
      icon: <Zap className="w-6 h-6 text-blue-900" />,
    },
    {
      title: "Asset Stewardship",
      description:
        "Our facilities are sanctuaries for your inventory. Clean, secure, and technologically advanced, we treat your assets as our own.",
    ...
    <div className="bg-white font-sans text-slate-900">
        ...
        <div className="container max-w-4xl text-center mx-auto px-6 relative z-20 text-white">
          <div>
            ...
            <p className="text-xl text-slate-100 leading-relaxed">
              Specializing in the high-stakes world of B2B import-to-domestic
              warehousing. We provide the enterprise-level infrastructure your
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-blue-900 font-bold text-sm tracking-[0.3em] uppercase">
              Our Story
            </h2>
            ...
            <div className="space-y-4 text-lg text-slate-600   leading-relaxed">
              <p>
                The logistics industry is polarized: massive legacy
                conglomerates with zero speed, or small shops lacking the
                technology to scale. We bridge that gap.
              </p>
              <p>
                Born from a frustration with the slow-moving machinery of
                traditional 3PLs, we built a partner that combines the{" "}
                <strong>infrastructure of an enterprise giant</strong> with the
                agility of a boutique firm.
              </p>
              <p>
                For businesses importing into the USA, the warehouse is the
                sanctuary for their investment. We don&apos;t just store goods;
                we steward your growth through meticulous domestic distribution.
              </p>
            </div>
          </div>
      ...
      <section className="relative py-36 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <h2 className="text-blue-300 font-bold text-sm tracking-[0.4em] uppercase mb-10">
            Our Mission
          </h2>
          <blockquote className="max-w-5xl mx-auto">
            <p className="text-4xl md:text-6xl   italic leading-[1.15] mb-12">
              &quot;To be the invisible engine of our clients&apos; growth,
              turning the complexity of US distribution into a silent
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-center text-center items-center mb-16 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-slate-900 font-bold text-xs tracking-[0.4em] uppercase mb-4">
              The CORE Pillars
            </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, idx) => (
            <div
              key={idx}
              className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl hover:border-blue-100 transition-all group"
            >
          ...
          <div className="relative z-10 w-full grid lg:grid-cols-2 gap-12 p-8 md:p-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-slate-300 text-lg md:text-xl   max-w-lg leading-relaxed">
                Stop fighting legacy logistics. Partner with a 3PL that views
                warehousing as a high-precision discipline. Ready for high-grade
                B2B results?
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-5 pt-4">
                ...
                <button className="bg-white/5 backdrop-blur-md border border-white/10 text-white px-8 py-4 rounded-lg font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-3">
                  <Warehouse size={18} className="text-blue-300" /> View Our
                  Services
                </button>
              </div>
            </div>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white/5 backdrop-blur-sm border border-white/5 p-6 rounded-2xl"
                >
                  <p className="text-blue-300 text-3xl font-bold mb-1">
                    {stat.value}
                  </p>
