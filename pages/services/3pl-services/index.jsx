  ...
  const services = [
    {
      ...
      features: ["Climate-controlled Racking", "High-Value Cargo Security", "Real-time Inventory Accuracy"]
    },
    {
      ...
      features: ["B2B Retail Compliance", "D2C Pick & Pack", "Same-Day Shipping"]
    },
    {
      ...
      features: ["Subscription Box Assembly", "Labeling & Barcoding", "Quality Control"]
    },
    {
    ...
    },
    {
      ...
      icon: <Truck size={32} />,
      features: ["LTL & FTL Management", "Rate Optimization", "Carrier Negotiation"]
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "We focus on partnering with established brands and growing B2B operations. While we don't have a rigid 'one-size-fits-all' minimum, our infrastructure is best suited for businesses with consistent volume. Contact us to discuss your specific profile."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely. We are equipped to handle EDI integration for major retailers, ensuring your wholesale orders meet strict routing guides and labeling requirements (UCC-128)."
    },
    {
      question: "I don't see a 'Get a Quote' button. How do we start?",
      answer: "We believe logistics requires a conversation, not an algorithm. To ensure we are the right fit for your business, we handle all inquiries directly. Email us or call to speak with an operations director."
    },
    {
      question: "How quickly can you integrate with my store?",
      answer: "Our systems connect seamlessly with major platforms (Shopify, WooCommerce, Magento) and ERPs. Once terms are agreed upon, we can typically integrate and begin receiving inventory within days, not months."
    }
  ];
  ...
  return (
    <main className="bg-white text-gray-900 font-sans">
      ...
      <section className="relative text-white py-32 px-6 overflow-hidden flex items-center justify-center min-h-[80vh]">
        ...
        />
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-gray-900/90 via-gray-900/80 to-blue1/70 z-10" />
        ...
        <div className="max-w-7xl text-center relative z-20">
          ...
          <p className="max-w-3xl text-xl text-gray-300 leading-relaxed mb-10 mx-auto">
            Comprehensive logistics handling warehousing, fulfillment, and distribution. 
      ...
      <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-200">Execution-focused services for the modern supply chain.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Simplicity & Transparency</h3>
              <p className="text-gray-600 leading-relaxed">
                No hidden fees or complex tiered structures. We believe in clear, honest communication regarding your logistics.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              <Zap className="text-blue-600 mb-4 w-10 h-10" />
              <h3 className="text-xl font-bold mb-3 text-gray-900">Accuracy First</h3>
              <p className="text-gray-600 leading-relaxed">
                We prioritize getting the order right the first time. Our floor teams are trained to treat every SKU with precision.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-black text-gray-900 mb-12 text-center">Industries We Serve</h2>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <span className={`font-bold text-lg ${openFaq === idx ? "text-blue-300" : "text-white"}`}>
                    {faq.question}
                  </span>
      ...
      <section className="relative py-24 bg-white overflow-hidden">
        ...
        /> */}
        {/* <div className="absolute inset-0 -z-10 bg-gradient-to-r from-gray-950/80 to-blue1/50" /> */}
