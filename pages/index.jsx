        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-10 border border-gray-200 hover:shadow-xl transition">
              ...
              <p className="text-gray-700 mb-4">
                Tap into P2V&apos;s deep industry knowledge and established
                carrier relationships. Our team brings years of logistics
                experience and best practices refined across multiple client
                partnerships.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex gap-2">
