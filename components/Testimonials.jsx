...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    {
      id: 2,
      quote: "Since switching to Price Value Logistics for warehousing, our inventory accuracy has hit 99.9%. The real-time visibility portal gives us complete peace of mind during peak season spikes.",
    ...
    {
      id: 3,
      quote: "Price Value Logistics optimized our shipping routes and carrier selection, reducing our overall logistics spend by 18% in the first quarter alone. The ROI was immediate.",
      author: "David Rivera",
